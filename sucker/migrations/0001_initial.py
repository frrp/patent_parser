...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ma_sucker_citation', (
        ...
        db.send_create_signal('ma_sucker', ['Citation'])

        # Adding model 'Person'
        db.create_table('ma_sucker_person', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('ma_sucker', ['Person'])

        # Adding model 'Claim'
        db.create_table('ma_sucker_claim', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('ma_sucker', ['Claim'])

        # Adding model 'Patent'
        db.create_table('ma_sucker_patent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('ma_sucker', ['Patent'])

        # Adding M2M table for field citations on 'Patent'
        m2m_table_name = db.shorten_name('ma_sucker_patent_citations')
        ...
        m2m_table_name = db.shorten_name('ma_sucker_patent_applicants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('patent', models.ForeignKey(orm['ma_sucker.patent'], null=False)),
            ('person', models.ForeignKey(orm['ma_sucker.person'], null=False))
        ))
        db.create_unique(m2m_table_name, ['patent_id', 'person_id'])

        # Adding M2M table for field inventors on 'Patent'
        m2m_table_name = db.shorten_name('ma_sucker_patent_inventors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('patent', models.ForeignKey(orm['ma_sucker.patent'], null=False)),
            ('person', models.ForeignKey(orm['ma_sucker.person'], null=False))
        ...
        m2m_table_name = db.shorten_name('ma_sucker_patent_assignees')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('patent', models.ForeignKey(orm['ma_sucker.patent'], null=False)),
            ('person', models.ForeignKey(orm['ma_sucker.person'], null=False))
        ...
        m2m_table_name = db.shorten_name('ma_sucker_patent_examiners')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('patent', models.ForeignKey(orm['ma_sucker.patent'], null=False)),
            ('person', models.ForeignKey(orm['ma_sucker.person'], null=False))
        ...
        m2m_table_name = db.shorten_name('ma_sucker_patent_claims')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('patent', models.ForeignKey(orm['ma_sucker.patent'], null=False)),
            ('claim', models.ForeignKey(orm['ma_sucker.claim'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ma_sucker_citation')

        # Deleting model 'Person'
        db.delete_table('ma_sucker_person')

        # Deleting model 'Claim'
        db.delete_table('ma_sucker_claim')

        # Deleting model 'Patent'
        db.delete_table('ma_sucker_patent')

        # Removing M2M table for field citations on 'Patent'
        db.delete_table(db.shorten_name('ma_sucker_patent_citations'))

        # Removing M2M table for field applicants on 'Patent'
        db.delete_table(db.shorten_name('ma_sucker_patent_applicants'))

        # Removing M2M table for field inventors on 'Patent'
        db.delete_table(db.shorten_name('ma_sucker_patent_inventors'))

        # Removing M2M table for field assignees on 'Patent'
        db.delete_table(db.shorten_name('ma_sucker_patent_assignees'))

        # Removing M2M table for field examiners on 'Patent'
        db.delete_table(db.shorten_name('ma_sucker_patent_examiners'))

        # Removing M2M table for field claims on 'Patent'
        db.delete_table(db.shorten_name('ma_sucker_patent_claims'))
